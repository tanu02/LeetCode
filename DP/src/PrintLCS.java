...
class Main5 {
    public static void main(String[] args) {
        ...
        System.out.println(sol.print("abcde", "ace")); //ace
        System.out.println(sol.print("abc", "abc")); //abc
        System.out.println(sol.print("ab", "ab")); //ab
        System.out.println(sol.print("a", "a")); //a
    }
}
