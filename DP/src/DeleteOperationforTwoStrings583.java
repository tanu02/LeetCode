...
//declare dp, initialize dp with len + 1
...
//        word1 = "sea", word2 = "eat"
        DeleteOperationforTwoStrings583 sol = new DeleteOperationforTwoStrings583();
        System.out.println(sol.minDistance("sea", "eat")); //2
        System.out.println(sol.minDistance("leetcode", "etco")); //4
    }
}
